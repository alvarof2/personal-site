  ...
  >
    <article className="post" id="index">
      ...
      <p> Welcome to my website. Please feel free to read more <Link to="/about">about me</Link>,
        ...
        <Link to="/resume">resume</Link> (also available as <a href="https://drive.google.com/file/d/1ari72Hmw6ajKEuFt8PRNN4EZDINqccUE/view?usp=sharing">pdf file</a>) with <a href="https://github.com/alvarof2/latex-cv">source code</a>, {' '}
