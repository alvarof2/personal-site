  ...
  >
    <article className="post" id="index">
      ...
      <p> Welcome to my website. Please feel free to read more <Link to="/about">about me</Link>,
        ...
        <Link to="/resume">resume</Link> (also available in <a href="https://drive.google.com/file/d/1U-_QUiusThRz20DEGw_3tQUpzetpL58C/view?usp=sharing">pdf format</a> with source code <a href="https://github.com/alvarof2/latex-cv">here</a>), {' '}
